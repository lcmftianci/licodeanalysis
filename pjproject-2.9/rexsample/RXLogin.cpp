/* $Id: simpleua.c 5943 2019-03-08 02:57:22Z ming $ */
/*
...
int main(int argc, char *argv[])
{
	...
	/* Create global endpoint: */
	{
		...
		*/
		...
		pj_str_t hostname = {NULL, 0};
		hostname.slen = sizeof("39.106.13.209");
		hostname.ptr = (char*)malloc(sizeof("39.106.13.209"));
		memcpy(hostname.ptr, "39.106.13.209", sizeof("39.106.13.209"));
	...
	*/
	{
		...
		if (AF == pj_AF_INET()) {
			...
			status = pjsip_udp_transport_start6(g_endpt, &addr.ipv6, NULL, 1, NULL);
		}
		else {
			status = PJ_EAFNOTSUP;
		}
...
#  endif  /* PJMEDIA_HAS_FFMPEG_VID_CODEC */
	...
	*/
	if (argc > 1) 
	{
		...
		pj_ansi_sprintf(temp, "<sip:lobao@%s:%d>", hostip, SIP_PORT);
