...
static GMutex* gather_mutex = NULL, *negotiate_mutex = NULL;
static GCond* gather_cond = NULL, *negotiate_cond = NULL;
//static GMutex* gather_mutex = NULL, *negotiate_mutex = NULL;//modify use pointer
//static GCond* gather_cond = NULL, *negotiate_cond = NULL;//modify use pointer
...
main(int argc, char *argv[])
{
  ...
  GError* ger = NULL;
  gexamplethread = g_thread_create(&example_thread, NULL, 1, &ger);
